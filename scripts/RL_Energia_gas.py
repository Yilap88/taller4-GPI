...
plt.xlabel('X')
plt.ylabel('Y')
plt.title('Regresión Lineal Energía vs Precio del Gas')

# Agregar leyenda
plt.legend()

# Guardar la grafica como un archivo .png
plt.savefig('results/figures/01_RL_Energia_gas_grafica.png', format="png", bbox_inches="tight", dpi=300)
...
plt.savefig('results/tables/01_RL_Energia_gas_evaluacion.png', format="png", bbox_inches="tight", dpi=300)
