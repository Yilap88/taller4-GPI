...
plt.xlabel('X')
plt.ylabel('Y')
plt.title('Regresión Lineal Energía vs Precio del Petróleo')

# Agregar leyenda
plt.legend()

# Guardar la grafica como un archivo .png
plt.savefig('results/figures/03_RL_Energia_petroleo_grafica.png', format="png", bbox_inches="tight", dpi=300)
...
plt.savefig('results/tables/03_RL_Energia_petroleo_evaluacion.png', format="png", bbox_inches="tight", dpi=300)
