...
X = df[['P_energia']]  # Variables predictoras
y = df['embalses']  # Variable dependiente
...
plt.xlabel('X')
plt.ylabel('Y')
plt.title('Regresión Lineal Energía vs Nivel de los Embalses')

# Agregar leyenda
plt.legend()

# Guardar la grafica como un archivo .png
plt.savefig('results/figures/04_RL_Energia_embalses_grafica.png', format="png", bbox_inches="tight", dpi=300)
...
plt.savefig('results/tables/04_RL_Energia_embalses_evaluacion.png', format="png", bbox_inches="tight", dpi=300)
